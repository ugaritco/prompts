...
$ansiOutput = [
    ...
    "    0 [>---------------------------]\e[1G\e[2K    0 [->--------------------------]\e[1G\e[2K    0 [--->------------------------]\e[1G\e[2K  - Installing \e[32mheritage/conditionable\e[39m (\e[33mv12.49.0\e[39m): Extracting archive",
    "  - Installing \e[32mheritage/macroable\e[39m (\e[33mv12.49.0\e[39m): Extracting archive",
    ...
    "  - Installing \e[32mugarit/prompts\e[39m (\e[33mv0.3.11\e[39m): Extracting archive",
    ...
    "  - Installing \e[32mheritage/contracts\e[39m (\e[33mv12.49.0\e[39m): Extracting archive",
    "  - Installing \e[32mspatie/ugarit-package-tools\e[39m (\e[33m1.92.7\e[39m): Extracting archive",
    ...
    "  - Installing \e[32mheritage/collections\e[39m (\e[33mv12.49.0\e[39m): Extracting archive",
    ...
    "  - Installing \e[32mspatie/ugarit-data\e[39m (\e[33m4.19.1\e[39m): Extracting archive",
...
$plainOutput = [
    ...
    '  - Installing heritage/conditionable (v12.49.0): Extracting archive',
    '  - Installing heritage/macroable (v12.49.0): Extracting archive',
    ...
    '  - Installing ugarit/prompts (v0.3.11): Extracting archive',
    ...
    '  - Installing heritage/contracts (v12.49.0): Extracting archive',
    '  - Installing spatie/ugarit-package-tools (1.92.7): Extracting archive',
    ...
    '  - Installing heritage/collections (v12.49.0): Extracting archive',
    ...
    '  - Installing spatie/ugarit-data (4.19.1): Extracting archive',
