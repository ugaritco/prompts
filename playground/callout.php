...
callout(
    ...
    [
        ...
        Element::numberedList([
            'Flush the Redis cache with `php scribe cache:clear`',
            'Restart queue workers with `php scribe queue:restart`',
            'Review the schedule output with `php scribe schedule:list`',
        ]),
    ],
    'warning',
);
...
callout(
    ...
    [
        ...
        Element::bulletedList([
            ...
            'Run `php scribe migrate:fresh` in development environments',
